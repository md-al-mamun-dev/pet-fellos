...
export default function HowAdoptionWorks() {
  return (
    <div className="mt-28 mb-36">
        <h2 className="section-title-1">How Adoption Works </h2>
        <div className="container-section flex justify-center gap-x-14 mt-12">
            <div className="py-6 px-8 max-w-72 rounded-lg shadow-xl ">
                <div className="w-max p-4 rounded-full bg-blue-50 mx-auto">
